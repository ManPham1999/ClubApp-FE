...
export const loginAdmin = (userName, passWord) => (dispatch) => {
  axios
    .post("https://funnyclub-be.herokuapp.com/api/student/login", {
      userName,
      passWord,
    })
    .then((res) => {
...
export const getProfileAdmin = (userName, passWord) => (dispatch) => {
  axios
    .get("https://funnyclub-be.herokuapp.com/api/student", {
      userName,
      passWord,
    })
    .then((res) => {
...
export const getAllTotalClub = () => (dispatch) => {
  axios
    .get("https://funnyclub-be.herokuapp.com/api/club/getAllClub")
    .then((res) => {
      dispatch({
...
export const getAllTotalEvent = () => (dispatch) => {
  axios
    .get("https://funnyclub-be.herokuapp.com/api/event/getAll")
    .then((res) => {
      dispatch({
